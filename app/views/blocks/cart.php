        ...
        <div class="row">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="continue__btn">
                            <a href="<?php echo HOST_ROOT ?>/shop">Tiếp tục mua sắm</a>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="continue__btn update__btn">
                            <a onclick="updateCart()"><i class="fa fa-spinner"></i> Cập nhật giỏ hàng</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="cart__total">
                    <h6>Thành tiền</h6>
                    <ul>
                        <li>Tổng cộng <span id="tongTienGH"> <?php echo !empty($tongTien) ? $tongTien :0 ?></span></li>
                    </ul>
                    <a href="<?php echo HOST_ROOT ?>/checkout" class="primary-btn">Tiến hành thanh toán</a>
                </div>
            </div>
        </div>
    </div>
