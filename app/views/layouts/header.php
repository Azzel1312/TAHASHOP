                ...
                <div class="row">
                    <div class="col-lg-12 text-right">
                        <div class="logo_container">
                            <a href="<?php echo HOST_ROOT ?>">TAHA<span>Shop</span></a>
                        </div>
                        <nav class="navbar">
                            <ul class="navbar_menu">
                                <li><a href="<?php echo HOST_ROOT ?>/">TRANG CHỦ</a></li>
                                <li><a href="<?php echo HOST_ROOT ?>/shop">SẢN PHẨM</a></li>
                                <li><a href="<?php echo HOST_ROOT ?>/about">VỀ TAHASHOP</a></li>
                                <li><a href="<?php echo HOST_ROOT ?>/purchase_order">ĐƠN HÀNG</a></li>
                                <li><a href="<?php echo HOST_ROOT ?>/contact">LIÊN HỆ</a></li>
                            </ul>
    ...
    <div class="hamburger_menu">
        ...
        <div class="hamburger_menu_content text-right">
            <ul class="menu_top_nav">
                ...
                <li class="menu_item"><a href="<?php echo HOST_ROOT ?>/">TRANG CHỦ</a></li>
                <li class="menu_item"><a href="<?php echo HOST_ROOT ?>/shop">SẢN PHẨM</a></li>
                <li class="menu_item"><a href="<?php echo HOST_ROOT ?>/about">VỀ TAHASHOP</a></li>
                <li class='menu_item'><a href='<?php echo HOST_ROOT ?>/purchase_order'>ĐƠN HÀNG</a></li>


                <li class="menu_item"><a href="<?php echo HOST_ROOT ?>/contact">LIÊN HỆ</a></li>
            </ul>
        </div>
    </div>
    <!-- Deal of the week -->
